...
// create a custom Leaflet icon using L.divIcon and specify
// the SVG element's outer HTML directly in the html option.
var customIcon = L.divIcon({
  html: iconElement.outerHTML,
  // The iconSize  sets the size of the icon to [32, 32].
